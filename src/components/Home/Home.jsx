    ...
    <div className='overflow-x-hidden overflow-y-hidden'>
        <div className='hero h-[100vh]'>
            ...
            <div className="absolute top-72 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
              <h2 className="text-2xl sm:text-5xl font-semibold mb-2 font-Fira uppercase">Welcome To</h2>
              <h1 className="text-4xl sm:text-7xl font-bold mb-7 font-Fira">Code And Blog</h1>
              <button className="bg-orange-500 text-white font-bold py-2 px-4 rounded-lg text-lg hover:bg-orange-600 transition duration-300">Get Started</button>
            </div>
